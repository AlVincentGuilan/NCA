@extends('layouts.default')
    ...
    @section('meta')
        ...
        <meta name="description" content="add new employee, delete employee, edit employee">
    @endsection
                        ...
                        <div class="box-body">
                            ...
                            <div class="field">
                                ...
                                <select name="company" class="ui search dropdown uppercase">
                                    ...
                                    <option value="Nca Manpower">NCA Manpower & General Services</option>
                                    <option value="Nca Abrahan Builders">NCAbrahan Builders</option>
                                    <option value="Nca GeneralMerchandize">NCA Construction Supply & General Merchandize</option>
                                    @isset($company)
                            ...
                            <div class="field">
                                ...
                                <select name="department" class="ui search dropdown uppercase department">
                                    ...
                                    <option value="Merchandize">General Merchandize</option>
                                    @isset($department)
